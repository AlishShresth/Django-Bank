...
class Profile(TimeStampedModel):
    ...
    title = models.CharField(_("Salutation"), max_length=5, default=Salutation.MR)
    ...
    means_of_identification = models.CharField(
        ...
        default=IdentificationMeans.CITIZENSHIP_CARD,
    )
    ...
    nationality = models.CharField(_("Nationality"), max_length=14, default="Nepali")
