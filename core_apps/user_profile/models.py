...
class Profile(TimeStampedModel, SoftDeleteModel):
    ...
    means_of_identification = models.CharField(
        ...
        default=IdentificationMeans.CITIZENSHIP,
    )
    ...
    country = models.CharField(_("Country"), default=settings.DEFAULT_COUNTRY)
...
class NextOfKin(TimeStampedModel):
    ...
    def __str__(self) -> str:
        return f"{self.first_name} {self.last_name} - Next of Kind for {self.profile.user.full_name}"
