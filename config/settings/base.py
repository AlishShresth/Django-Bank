...
DJANGO_APPS = [
    ...
    "django.contrib.sites",  # Manage multiple sites with one project
    "django.contrib.humanize",  # For template readability like email templates
]
...
DEFAULT_COUNTRY = "NP"
DEFAULT_PHONE_NUMBER = "+977-9841000000"
REST_FRAMEWORK = {
